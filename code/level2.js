...
const trunk_diff = txloader.load("../assets/scene/textures/level1/defense_wall_diff_1k.jpg");
...
var light1 = new THREE.PointLight(0xe45233, 0.75, 250); // (color; intensity; distance; decay)
light1.position.set( 0, 10, -5 );
light1.castShadow = true;

var light2 = new THREE.PointLight(0xffd966, 0.75, 250); // (color; intensity; distance; decay)
...
var sunlight = new THREE.AmbientLight(0xffffff, 1.0); // (color; intensity)
...
var trunk_geometry = new THREE.CylinderGeometry( 0.75, 0.75, 5, 10 );
...
var pike_geometry = new THREE.BoxGeometry(1.35, 0.15, 1.35);
...
pike_mesh_1.position.y = 0.75; pike_mesh_1.rotation.y=Math.PI/3;
...
pike_mesh_2.position.y = 1.5; pike_mesh_2.rotation.y=Math.PI/4;
...
pike_mesh_3.position.y = 0.25; pike_mesh_3.rotation.y=Math.PI/4;
Tree.add(pike_mesh_3);

var top_geometry = new THREE.TetrahedronGeometry(1.6, 0);
var pike_mesh_4 = new THREE.Mesh(top_geometry, pike_material);
...
// ----------
// COLUMNS
var wall_geometry = new THREE.BoxGeometry(0.5, 2.5, 0.5);
...
var saw_center_geometry = new THREE.CylinderGeometry(0.3, 0.3, 0.3, 24);
...
var levelBG_animations = function(obj){
    ...
    block1_animations(wall_4);
    block1_animations(wall_5);

    block2_animations(wall_4);
    block2_animations(wall_5);
