...
world_norm.wrapS = THREE.RepeatWrapping; world_norm.wrapT = THREE.RepeatWrapping; world_norm.repeat.set( 16, 16 );
world_roug.wrapS = THREE.RepeatWrapping; world_roug.wrapT = THREE.RepeatWrapping; world_roug.repeat.set( 16, 16 );
...
var dirLight1 = new THREE.DirectionalLight(0xffffff, 0); // (color; intensity)
...
// ----------
// COLUMNS
var wall_geometry = new THREE.BoxGeometry(0.7, 2.5, 0.7);
