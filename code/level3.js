...
var tail_geometry = new THREE.CylinderGeometry( 0, 0.4, 3.5, 6 );
...
var tail_mesh = new THREE.Mesh(tail_geometry, tail_material);
tail_mesh.castShadow = true; tail_mesh.receiveShadow = true;
tail_mesh.position.y = 2.0; tail_mesh.position.z = -1.0; 
tail_mesh.rotation.x=-Math.PI/6;
//tail_mesh.rotation.y=-Math.PI/3;
kernel_mesh.add(tail_mesh);
...
var levelBG_animations = function(obj){
    ...
    block2_animations(wall_3.children[0]);
